    ...
    <AppShell>
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <h2 className="text-4xl font-extrabold font-headline tracking-tight">Hub de Ressources 📚</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {MOCK_RESOURCES.map((resource) => (
            <Card key={resource.id} className="group hover:scale-[1.02] hover:shadow-2xl transition-all duration-300 border-none shadow-xl bg-white/80 backdrop-blur-sm overflow-hidden flex flex-col">
